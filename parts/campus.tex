...
\begin{tabular}{*{3}{p{\largcol}}}
  \pers{}{Arnaud \textsc{Poitou}}{Director}{He's everybody's boss. We all have to swear allegiance to him, even if you not often have to be dealing with him}&%C'est notre chef à tous. On lui doit allégeance, même si en pratique, on a rarement affaire à lui.}&
...
%  \pers{}{}{Directeur adjoint}{C'est l'homme de terrain. Il met à exécution les grandes décisions « concrètes » de l'administration. Vous recevrez notamment pas mal de mails durant l'année sur d'éventuels travaux, changement d'organisation, etc. de sa part.}
  \pers{}{Édith \textsc{Boutin}}{PhD students secretary}{She deals more specifically with PhD students. You will see her again for re-enrolment each year, and many other enquiries.}&
...
%\subsection{Map of the École Centrale Nantes}\trad
%\todo{Inclure le plan}
